    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 bg-ui-bg-base border-x border-b border-ui-border-strong w-[420px] text-ui-fg-base rounded-lg shadow-lg"
